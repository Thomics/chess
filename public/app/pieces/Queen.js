function Queen(id, color, piece, letter) {
...
Queen.prototype.createMoves = function(currentSquare) {
  var legalMoves = [];

  //Creates Queens diagonal movement list.
  var diagonalMoves = queenDiagonalMoves(currentSquare, this.color, 9, 'forward');
  legalMoves = diagonalMoves.concat(legalMoves);
  diagonalMoves = queenDiagonalMoves(currentSquare, this.color, 9, 'backward');
  legalMoves = diagonalMoves.concat(legalMoves);
  diagonalMoves = queenDiagonalMoves(currentSquare, this.color, 7, 'forward');
  legalMoves = diagonalMoves.concat(legalMoves);
  diagonalMoves = queenDiagonalMoves(currentSquare, this.color, 7, 'backward');
  legalMoves = diagonalMoves.concat(legalMoves);

  //Creates Queens vertical movement list.
  var verticalMoves = queenVerticalMoves(currentSquare, this.color, 'forward');
  legalMoves = verticalMoves.concat(legalMoves);
  verticalMoves = queenVerticalMoves(currentSquare, this.color, 'backwards');
  legalMoves = verticalMoves.concat(legalMoves);

  //Creates Queens horizontal movement list
  var horizontalMoves = queenHorizontalMoves(currentSquare, 1, this.color, 'forward');
  legalMoves = horizontalMoves.concat(legalMoves);
  horizontalMoves = queenHorizontalMoves(currentSquare, 1, this.color, 'backwards');
  legalMoves = horizontalMoves.concat(legalMoves);
...
function queenDiagonalMoves(currentSquare, color, offset, direction) {
  var availableMoves = [];
  var count = offset;
...
function queenVerticalMoves(currentSquare, color, direction) {
  var availableMoves = [];
  var offset = 8;
...
function queenHorizontalMoves(currentSquare, offset, color, direction) {
  var availableMoves = [];
  var count = offset;
  var boardEdges = [0, 8, 16, 24, 32, 40, 48, 56, 7, 15, 23, 31, 39, 47, 55, 63];
